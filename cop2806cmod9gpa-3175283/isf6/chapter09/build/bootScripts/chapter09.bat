...
set JARPATH=%APP_HOME%\lib\chapter09.jar

@rem Execute chapter09
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CHAPTER09_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%CHAPTER09_EXIT_CONSOLE%" exit 1
exit /b 1
